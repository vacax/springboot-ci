...
FROM gradle:8.14-jdk21-noble AS build
...
COPY --from=build /home/gradle/src/build/libs/*.jar /app/springboot-ci.jar
ENTRYPOINT ["java", "-Djava.security.egd=file:/dev/./urandom","-jar","/app/springboot-ci.jar"]